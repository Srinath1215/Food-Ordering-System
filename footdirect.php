...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal ">FOODCAVE</h4>
            <p class="mt-2 mb-3 fw-normal h6 ">srinathashok12@gmail.com</p>
            <p class="mb-3 fw-bold text-bold text-wrap">FOOD ORDERING SYSTEM</p>
            <h4 class="mt-2 mb-3 fw-normal ">Contact</h4><p class="mt-2 mb-3 fw-normal h6 ">7538891215 </p>
